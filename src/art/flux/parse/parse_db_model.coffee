define [
  'lib/art/foundation'
  'lib/art/flux/db/flux_db_model'
  './parse_util'
  './parse_db_query_model'
], (Foundation, FluxDbModel, ParseUtil, ParseDbQueryModel) ->
  {BaseObject, mergeInfo, log, clone, slice, merge, arrayWithOne, peek, inspect, isArray, isString, objectWithout, globalCount, time} = Foundation

  {saveParseObject, parseCallbackHandlers} = ParseUtil
  ...
  class ParseDbModel extends FluxDbModel
    @singletonClass()
